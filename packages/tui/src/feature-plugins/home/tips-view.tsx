...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent opencode-prime from reading sensitive files",
  "Use {highlight}opencode-prime run{/highlight} for non-interactive scripting",
  "Use {highlight}opencode-prime --continue{/highlight} to resume the last session",
  "Use {highlight}opencode-prime run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}opencode-prime serve{/highlight} for headless API access to opencode-prime",
  "Use {highlight}opencode-prime run --attach{/highlight} to connect to a running server",
  "Run {highlight}opencode-prime upgrade{/highlight} to update to the latest version",
  "Run {highlight}opencode-prime auth list{/highlight} to see all configured providers",
  "Run {highlight}opencode-prime agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}opencode-prime github install{/highlight} to set up the GitHub workflow",
